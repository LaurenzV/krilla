...
pub struct ResourceNumberAllocator {
    ...
    /// dictionary, e.g. "cs0".
    next_color_space_num: u32,
}

impl ResourceNumberAllocator {
    /// Allocate a new XObject name.
    pub fn alloc_x_object_number(&mut self) -> u32 {
    ...
    pub fn alloc_graphics_state_number(&mut self) -> u32 {
    ...
    pub fn alloc_shading_number(&mut self) -> u32 {
    ...
    /// Allocate a new shading name.
    pub fn alloc_font_number(&mut self) -> u32 {
    ...
    pub fn alloc_color_space_number(&mut self) -> u32 {
