...
// To prevent exposing pdf_writer to the public API.
pub(crate) mod conversions {
    use crate::embed::AssociationKind;
    use crate::page::NumberingStyle;
    use crate::surface::BlendMode;
    use crate::tagging::{ArtifactAttachment, ListNumbering, TableHeaderScope};
    ...
    impl From<NumberingStyle> for pdf_writer::types::NumberingStyle {
        fn from(value: NumberingStyle) -> Self {
            match value {
    ...
    impl From<ArtifactAttachment> for pdf_writer::types::ArtifactAttachment {
        fn from(value: ArtifactAttachment) -> Self {
            match value {
                ArtifactAttachment::Left => pdf_writer::types::ArtifactAttachment::Left,
                ArtifactAttachment::Top => pdf_writer::types::ArtifactAttachment::Top,
                ArtifactAttachment::Right => pdf_writer::types::ArtifactAttachment::Right,
                ArtifactAttachment::Bottom => pdf_writer::types::ArtifactAttachment::Bottom,
            }
        }
    }

    impl From<ListNumbering> for pdf_writer::types::ListNumbering {
        fn from(value: ListNumbering) -> Self {
            match value {
    ...
    impl From<TableHeaderScope> for pdf_writer::types::TableHeaderScope {
