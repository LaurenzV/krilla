...
impl<'a> Surface<'a> {
    ...
    ///
    /// # Panics
    /// Panics if a tagged section has already been started (either via this function or via
    ...
    ///
    /// # Panics
    /// Panics if a tagged/marked section has already been started (either via this function or via
