...
class TestTransformContext:
    ...
    def test_transform_context_manager(self):
        ...
        doc = Document()
        ps = PageSettings.from_wh(200, 200)
...
class TestBlendModeContext:
    ...
    def test_blend_mode_context_manager(self):
        ...
        doc = Document()
        ps = PageSettings.from_wh(200, 200)
        with doc.start_page_with(ps) as page, page.surface() as surface:  # noqa: SIM117
            # Should not crash
...
class TestExceptionSafety:
    ...
    def test_exception_in_nested_contexts(self):
        ...
        with doc.start_page_with(ps) as page, page.surface() as surface:
            try:
                with surface.transform(Transform.from_translate(10, 20)):  # noqa: SIM117
                    with surface.blend_mode(BlendMode.Multiply):
...
class TestComplexNesting:
    ...
    def test_complex_nesting(self):
        ...
        ps = PageSettings.from_wh(200, 200)
        with doc.start_page_with(ps) as page, page.surface() as surface:  # noqa: SIM117
            with surface.transform(Transform.from_translate(50, 50)):  # noqa: SIM117
                with surface.blend_mode(BlendMode.Multiply):
