...
# ============================================================================
# Tag Tree Types (PDF/UA Accessibility)
# ============================================================================

class TagTree:
    """Root container for PDF tag tree (accessibility structure)."""
    def __init__(self) -> None: ...
    def push(self, node: Node | TagGroup | Identifier) -> None: ...

class TagGroup:
    """Group node in tag tree with semantic tag and children."""
    def __init__(self, tag: TagKind) -> None: ...
    @staticmethod
    def with_children(tag: TagKind, children: list[Node]) -> TagGroup: ...
    def push(self, node: Node | TagGroup | Identifier) -> None: ...
    @property
...
class Node:
    ...
    @staticmethod
    def from_group(group: TagGroup) -> Node: ...
    @staticmethod
    def from_identifier(identifier: Identifier) -> Node: ...
...
class TagKind:
    ...
    def with_id(self, id: TagId | None) -> TagKind: ...
    def lang(self) -> str | None: ...
    def with_lang(self, lang: str | None) -> TagKind: ...
    def alt_text(self) -> str | None: ...
    def with_alt_text(self, alt_text: str | None) -> TagKind: ...
    def expanded(self) -> str | None: ...
    def with_expanded(self, expanded: str | None) -> TagKind: ...
    def actual_text(self) -> str | None: ...
    def with_actual_text(self, actual_text: str | None) -> TagKind: ...
    def title(self) -> str | None: ...
    # Struct-specific attributes
    def level(self) -> int | None: ...
    def numbering(self) -> ListNumbering | None: ...
    def summary(self) -> str | None: ...
    def scope(self) -> TableHeaderScope | None: ...
    # Table attributes
    def headers(self) -> list[TagId] | None: ...
    def row_span(self) -> int | None: ...
    def col_span(self) -> int | None: ...
    # Layout attributes
    def placement(self) -> Placement | None: ...
    def with_placement(self, placement: Placement | None) -> TagKind: ...
    def writing_mode(self) -> WritingMode | None: ...
    def with_writing_mode(self, writing_mode: WritingMode | None) -> TagKind: ...
    def bbox(self) -> BBox | None: ...
    def width(self) -> float | None: ...
    def height(self) -> float | None: ...
    def background_color(self) -> NaiveRgbColor | None: ...
    def with_background_color(
        self, background_color: NaiveRgbColor | None
    ) -> TagKind: ...
    def color(self) -> NaiveRgbColor | None: ...
    def with_color(self, color: NaiveRgbColor | None) -> TagKind: ...
    def padding(self) -> SidesF32 | None: ...
    def with_padding(self, padding: SidesF32 | None) -> TagKind: ...
    def text_align(self) -> TextAlign | None: ...
    def block_align(self) -> BlockAlign | None: ...
    def inline_align(self) -> InlineAlign | None: ...
...
class Tag:
    ...
    def Span() -> TagKind: ...
    @staticmethod
    def InlineQuote() -> TagKind: ...
    @staticmethod
    def Note() -> TagKind: ...
    @staticmethod
    def Reference() -> TagKind: ...
    @staticmethod
    def BibEntry() -> TagKind: ...
    @staticmethod
    def Code() -> TagKind: ...
    @staticmethod
    def Link() -> TagKind: ...
    ...
    def Annot() -> TagKind: ...
    @staticmethod
    def NonStruct() -> TagKind: ...
    @staticmethod
    def Datetime() -> TagKind: ...
    @staticmethod
    def Terms() -> TagKind: ...
    @staticmethod
    def Title() -> TagKind: ...
    ...
    @staticmethod
    def Hn(level: int) -> TagKind: ...
    @staticmethod
    def L(numbering: ListNumbering) -> TagKind: ...
    @staticmethod
    def TH(scope: TableHeaderScope) -> TagKind: ...
    # Tags with optional parameters
    @staticmethod
    def Table(summary: str | None = None) -> TagKind: ...
    @staticmethod
    def Figure(alt_text: str | None = None) -> TagKind: ...
    @staticmethod
    def Formula(alt_text: str | None = None) -> TagKind: ...

# Tag Attribute Enums

class ListNumbering(IntEnum):
    """List numbering style."""

    None_ = 0  # Note: Access as ListNumbering.None (Python allows this as attribute)
    Disc = 1
    Circle = 2
    Square = 3
    Decimal = 4
...
class TableHeaderScope(IntEnum):
...
class TextDecorationType(IntEnum):
...
class GlyphOrientationVertical(IntEnum):
    """Glyph orientation in vertical writing mode."""
...
class LineHeight:
    ...
    @staticmethod
    def normal() -> LineHeight: ...
    @staticmethod
    def auto() -> LineHeight: ...
    @staticmethod
    def custom(value: float) -> LineHeight: ...
...
class BBox:
    ...
    page_idx: int
    rect: Rect
    def __init__(self, page_idx: int, rect: Rect) -> None: ...
...
class NaiveRgbColor:
    ...
    @staticmethod
    def new_f32(red: float, green: float, blue: float) -> NaiveRgbColor: ...
...
class SidesF32:
    ...
    def __init__(
        self, before: float, after: float, start: float, end: float
    ) -> None: ...
    @staticmethod
    def uniform(value: float) -> SidesF32: ...

class ColumnDimensions:
    """Column widths specification."""
    @staticmethod
    def all(value: float) -> ColumnDimensions: ...
    @staticmethod
    def specific(values: list[float]) -> ColumnDimensions: ...
...
# Metadata text direction (different from text shaping direction)
class MetadataTextDirection(IntEnum):
    LeftToRight = ...
    RightToLeft = ...

class PageLayout(IntEnum):
    """How the PDF viewer should lay out pages."""
...
class DateTime:
    """A datetime for PDF metadata. Invalid values will be clamped."""
    def __init__(self, year: int) -> None: ...
    def month(self, month: int) -> DateTime: ...
    ...
    def utc_offset_hour(self, hour: int) -> DateTime: ...
    def utc_offset_minute(self, minute: int) -> DateTime: ...

class Metadata:
    """Metadata for a PDF document."""
    def __init__(self) -> None: ...
    def title(self, title: str) -> Metadata: ...
    def description(self, description: str) -> Metadata: ...
    def keywords(self, keywords: list[str]) -> Metadata: ...
    def language(self, language: str) -> Metadata: ...
    def creator(self, creator: str) -> Metadata: ...
    def producer(self, producer: str) -> Metadata: ...
    def authors(self, authors: list[str]) -> Metadata: ...
    def creation_date(self, creation_date: DateTime) -> Metadata: ...
    def document_id(self, document_id: str) -> Metadata: ...
    def text_direction(self, text_direction: MetadataTextDirection) -> Metadata: ...
    def page_layout(self, page_layout: PageLayout) -> Metadata: ...

class XyzDestination:
    """A destination pointing to a specific location on a specific page."""
    def __init__(self, page_index: int, point: Point) -> None: ...

class OutlineNode:
    """An outline node representing an entry in the document's navigation tree."""
    def __init__(self, text: str, destination: XyzDestination) -> None: ...
    def push_child(self, node: OutlineNode) -> None: ...
...
class Document:
    ...
    def set_tag_tree(self, tag_tree: TagTree) -> None:
        """Set the tag tree for PDF/UA accessibility."""
        ...
    def embed_file(self, file: EmbeddedFile) -> bool:
        """
