...
class Size:
    ...
    @staticmethod
    def from_wh(width: float, height: float) -> Optional[Size]: ...
    def __eq__(self, other: object) -> bool: ...
...
class Rect:
    ...
    def height(self) -> float: ...
    @staticmethod
    def from_xywh(x: float, y: float, width: float, height: float) -> Optional[Rect]: ...
    @staticmethod
    def from_ltrb(left: float, top: float, right: float, bottom: float) -> Optional[Rect]: ...
    def transform(self, transform: Transform) -> Optional[Rect]: ...
    def __eq__(self, other: object) -> bool: ...
...
class Transform:
    ...
    @staticmethod
    def from_row(sx: float, ky: float, kx: float, sy: float, tx: float, ty: float) -> Transform: ...
    @staticmethod
...
class Path:
    ...
    def transform(self, transform: Transform) -> Optional[Path]: ...
...
class color:
    ...
    class CmykColor:
        def __init__(self, cyan: int, magenta: int, yellow: int, black: int) -> None: ...
        @property
        def cyan(self) -> int: ...
        @property
...
# Paint types
PaintType = Union[color.RgbColor, color.LumaColor, color.CmykColor, color.Color, "LinearGradient", "RadialGradient", "SweepGradient", "Pattern"]

class Stop:
    """A gradient color stop."""
    def __init__(self, offset: NormalizedF32, color: color.Color, opacity: Optional[NormalizedF32] = None) -> None: ...
    @property
...
class LinearGradient:
    ...
    def __init__(
        ...
        y2: float,
        stops: Sequence[Stop],
        spread_method: Optional[SpreadMethod] = None,
...
class Paint:
    ...
    def __init__(self, paint: PaintType) -> None: ...
...
class Fill:
    ...
    def __init__(
        self,
        paint: PaintType,
        opacity: Optional[NormalizedF32] = None,
...
class Font:
    ...
    @staticmethod
    def new(data: bytes, index: int) -> Optional[Font]: ...
    @staticmethod
    def new_variable(data: bytes, index: int, variations: Sequence[Tuple[str, float]]) -> Optional[Font]: ...
...
class StreamBuilder:
    ...
    def __enter__(self) -> StreamBuilder: ...
...
class Pattern:
    """A pattern paint."""
    def __init__(self, stream: Stream, transform: Optional[Transform] = None) -> None: ...
...
class Configuration:
    ...
    @staticmethod
    def with_validator_and_version(validator: Validator, version: PdfVersion) -> Optional[Configuration]: ...
    @property
...
class PageSettings:
    ...
    def __init__(self, size: Size) -> None: ...
    @staticmethod
    def from_wh(width: float, height: float) -> Optional[PageSettings]: ...
    def with_media_box(self, media_box: Optional[Rect]) -> PageSettings: ...
    def with_crop_box(self, crop_box: Optional[Rect]) -> PageSettings: ...
    def with_bleed_box(self, bleed_box: Optional[Rect]) -> PageSettings: ...
    def with_trim_box(self, trim_box: Optional[Rect]) -> PageSettings: ...
    def with_art_box(self, art_box: Optional[Rect]) -> PageSettings: ...

# Core types
class Surface:
    """A drawing surface for a page or stream."""
    # Fill and stroke
    def set_fill(self, fill: Optional[Fill] = None) -> None: ...
    def get_fill(self) -> Optional[Fill]: ...
    def set_stroke(self, stroke: Optional[Stroke] = None) -> None: ...
    def get_stroke(self) -> Optional[Stroke]: ...
    # Drawing operations
    def draw_path(self, path: Path) -> None: ...
    def draw_glyphs(self, start: Point, glyphs: Sequence[KrillaGlyph], font: Font, text: str, font_size: float, outlined: bool = False) -> None: ...
    def draw_text(self, start: Point, font: Font, font_size: float, text: str, outlined: bool = False, direction: TextDirection = ...) -> None: ...
