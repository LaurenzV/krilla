...
pub fn render_tree(tree: &usvg::Tree, svg_settings: SvgSettings, surface: &mut Surface) -> Option<()> {
...
fn get_context_from_group(
    ...
    Some(ProcessContext::new(surface.convert_fontdb(tree_fontdb, Some(ids))?, svg_settings))
}
